package wheelerlaw.jetticalc;

import wheelerlaw.jetticalc.resource.Calculator;
...
public class API{
	public static void main(String[] args) throws Exception{
		...
		servletParams.put("jersey.config.server.provider.classnames", Calculator.class.getCanonicalName());
